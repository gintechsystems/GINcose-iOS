...
class BluetoothManager: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    private var managerQueue = DispatchQueue(label: "com.gintechsystems.GINcose.bluetoothManagerQueue", qos: .userInitiated)
    
    override init() {
        super.init()
        
        manager = CBCentralManager(delegate: self, queue: managerQueue, options: [CBCentralManagerOptionRestoreIdentifierKey: "com.gintechsystems.GINcose"])
    }
